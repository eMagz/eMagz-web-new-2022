...
const VideoConf = (props) => {
  ...
  useEffect(() => {
    Axios.get(`${BaseUrl}/user-requests-list/${props.location.state}`).then(
      (res) => {
    ...
    <>
        ...
        <div className="bodyvid">
          {isVideoStart && (
            ...
            >
              <div>
                <OTPublisher
                  properties={{ video, height: 201, width: '70%' }}
                  onPublish={onPublish}
        ...
        <footer>
          <div className="mainicon">
            <div className="buttonone">
              <IconButton
                style={{ color: "#A9A9A9", outline: "none", opacity: "0.6" }}
              >
            ...
            <div className="buttonthree">
              ...
              <div>
                <IconButton
                  onClick={(e) => setIsScreenStart(true)}
                  style={{ color: "white" }}
                >
      ...
      >
        ...
        <div className="videoNotification">
          {mettingUsers.length > 0 &&
            mettingUsers.map((data) => {
              ...
              return (
                <TabPanel value={value} index={0}>
                  <div style={{ display: "flex", padding: "0px 5px" }}>
                    ...
                    />
                    <h5 style={{ marginTop: "8px", marginRight: "5px" }}>
                      {data.name}
                    </h5>
        ...
        <div>
          <TabPanel value={value} index={1}>
            {videoMessage.length > 0 &&
              videoMessage.map((data) => {
                return (
                  <div style={{ margin: "10px 10px" }}>
                    <p style={{ color: "black", display: "block" }}>
                      <strong>{data.SenderName}</strong> <b>10:23 PM</b>
                    </p>
