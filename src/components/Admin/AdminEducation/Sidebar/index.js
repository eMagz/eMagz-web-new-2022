    ...
    <div className={drawerClasses}>
      ...
      <div style={{ marginTop: "10px" }}>
        <List component="nav">
          ...
          <Link to="/admin/education/schools">
            <ListItem button>
              <ListItemIcon>
          ...
          <Link to="/admin/education/deactivated-schools">
            <ListItem button>
              <ListItemIcon>
                <FontAwesomeIcon icon={faTshirt} />
              </ListItemIcon>
              <ListItemText primary="Deactivated Schools" />
            </ListItem>
          </Link>
          <Link to="/admin/education/new-school">
            <ListItem button>
              <ListItemIcon>
                <OpenInBrowserIcon />
              </ListItemIcon>
          ...
          <Link to="/admin/education/principals">
            <ListItem button>
              <ListItemIcon>
                <OpenInBrowserIcon />
              </ListItemIcon>
              <ListItemText primary="Principal Request" />
            </ListItem>
          </Link>
          <Link to="/admin/education/support">
            <ListItem button>
              <ListItemIcon>
                <PaymentIcon />
              </ListItemIcon>
