...
const Index = (props) => {
  ...
  console.log("PROPS", props)
    ...
    const handleDeactiveProfile = ()=>{
      swal({
        title: "Are you sure?",
        text: "Once Activated, It will visible on social media page.",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      }).then((isDeactivate)=>{
          if(isDeactivate){
            ...
            swal("Profile has been Deactivated!", {
              icon: "success",
              method: history.push(`/admin/emagz/deacvtive-users/`)
            });
          }else{
          ...
          <div className='more_details3' >
            ...
            <div className="detail_div">
             ...
             <div className='profile3_edit_btn' >
              <button onClick={handleDeactiveProfile} className='edit3_btn edit3_btn1' >Activate</button>
            </div>
          </div>
        </div>
      </div>
