...
useEffect(()=>{
    ...
    <>
      ...
      <Row form>
        ...
        <Input onChange={(e)=> setClasses(e.target.value)} required value={classes} type="select" name="select" id="exampleSelect">
        ...
        <Col md={4}>
        <Button style={{transform:'translateY(33px)'}}  onClick={()=>getTimetableData()} >Submit</Button>
        </Col>
      </Row>
