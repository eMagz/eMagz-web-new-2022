		...
		<>
			<Router>
				<Switch>
					...
					/>
					<Route exact path="/video-conference/dashborad" component={VideoDashborad} />
					<Route exact path="/video-conference/dashborad/home" component={Home} />
					<Route
						exact
					...
					/>
					<Route exact path="/video-conference/joinmeeting/:id" component={JoinMeeting} />
					<Route
						exact
					...
					<Route exact path="/eMagz/chat/video-calling" component={SocialVideoChat} />
					...
					<Route exact path="/educations/welcome" component={Welcome} />
					{/* Educations */}
					<Route exact path="/educations/admission" component={MainLandingpage} />
					<Route
						exact
						path="/educations/admission/register"
						component={StudentRegisterForm}
					/>
					<Route exact path="/educations/home-page" component={SchoolMainPage} />
					<Route
						exact
					...
					<Route exact path="/educations/my-profile/metting/home" component={VideoCall} />
					<Route
						exact
					...
					<Route exact path="/educations/student/chat" component={EduStudentChat} />
					<Route exact path="/educations/student/remarks" component={StudentRemark} />
					<Route exact path="/educations/notice-board" component={StudentNoticboard} />
					<Route exact path="/educations/homework" component={EditTeacher} />
					<Route exact path="/educations/home-works" component={StudentHomeWork} />
					<Route exact path="/educations/class-diary" component={ViewStudentList} />
					...
					/>
					<Route exact path="/educations/attendance" component={StudentAttendance} />
					<Route exact path="/educations/apply-a-leave" component={ApplyLeave} />
					<Route exact path="/educations/apply-a-leave/view-all" component={LeaveList} />
					...
					<Route exact path="/educations/test-details" component={TestDetails} />
					<Route exact path="/educations/take-a-test" component={TestDetails} />
					<Route exact path="/educations/take-a-test/online-test" component={ShortTest} />
					<Route exact path="/educations/bus-tracking" />
					<Route exact path="/educations/feedback" component={Feedback} />
					<Route exact path="/educations/contact-us" component={StudentcontactUs} />
					<Route exact path="/educations/bus-tracking" component={BusTracking} />
					<Route
						exact
					...
					<Route exact path="/educations/contact-us" component={StudentContactus} />
					{/* Teacher */}
					<Route exact path="/educations/teachers/chat" component={EduTeacherChat} />
					<Route exact path="/educations/teacher/profile" component={TeacherProfile} />
					<Route exact path="/educations/student/profile" component={StudentProfile} />
					<Route
						exact
					...
					<Route exact path="/educations/teacher/add-test" component={CreateTest} />
					<Route exact path="/educations/teacher/test-list" component={TestTeacher} />
					<Route
						exact
					...
					<Route exact path="/educations/bus-tracking" />
					<Route exact path="/educations/teacher/feedback" component={TeacherFeedback} />
					<Route
						exact
					...
					/>
					{/* Principal */}
					<Route exact path="/educations/principal/chat" component={EduPrincipalChat} />
					...
					/>
					<Route exact path="/educations/principal/add-fees" component={AddFees} />
					<Route
						exact
					...
					<Route exact path="/admin/dashboard/profile" component={AdminProfile} />

					<Route exact path="/admin/business/vendor-list" component={VendorList} />
					...
					/>
					<Route exact path="/admin/business/support" component={AdminBusinessChat} />

					<Route exact path="/admin/education/schools" component={AdminEducation} />
					<Route exact path="/admin/education/principals" component={GetPrincipals} />
					<Route
						exact
					...
					/>
					<Route exact path="/admin/education/new-school" component={AddNewSchool} />
					<Route
						exact
					...
					/>
					<Route exact path="/admin/education/schools/:id" component={AdminSchoolDetal} />
					...
					<Route exact path="/business/edit-approve-form" component={EditApprovalForm} />
					{/* Business User */}
					<Route exact path="/business/user-dashboard" component={UserDashboard} />
					<Route
						exact
						path="/business/user-dashboard/subcategories"
						component={BuainessSubcategories}
					/>
					<Route exact path="/business/user-dashboard/carts" component={UserCarts} />
					<Route exact path="/business/payment-summery" component={PaymentGatway} />
					<Route
						exact
					...
					<Route
						exact
						path="/business/user-dashboard/profile/coupon"
						component={Coupon}
					/>

					<Route
						exact
						path="/business/user-dashboard/profile/review"
						component={Review}
					/>
          ...
          /> */}
					<Route exact path="/business/edit-profile" component={UserProfileEdit} />
					<Route exact path="/business/payments-view" component={PaymentDetails} />

					<Route exact path="/business/user-dashboard/:name" component={ProductDetails} />
					<Route exact path="/business/orders" component={Orders} />
					<Route exact path="/business/profile/my-orders/support" component={Support} />
					<Route exact path="/business/products" component={VendorDashboard} />
					{/* Business */}
					<Route exact path="/bussiness/dashboard/" component={VendorsDashborad} />
					<Route
						exact
					...
					/>
					<Route exact path="/business/vendor-dashboard/coupons" component={CouponList} />
					<Route
						exact
					...
					/>
					<Route exact path="/business/payments-view" component={PaymentDetails} />
					<Route exact path="/business/vendor-dashboard/orders" component={Orders} />
					<Route
						exact
						path="/business/orders-list/order-details"
						component={OrderDetails}
					/>
					<Route exact path="/business/vendor-dashboard" component={VendorDashboard} />
					<Route exact path="/business/products/clothing" component={Clothings} />
					<Route exact path="/business/products/books" component={Books} />
					<Route exact path="/business/products/tv-appliances" component={Appliances} />
					<Route
						exact
					...
					<Route exact path="/business/products/electronics" component={Electronics} />
					<Route
						exact
						path="/business/orders-list/order-details/print"
						component={MyDocument}
					/>
					<Route exact path="/business/:name/:id" component={BusinessTemplagte} />
					...
					<Route exact path="/dashboard/term-conditions" component={Termsconditions} />
